...
//      1. INDEX (index always change id not change better to use id)
...
//        iframe ile isimiz bitince buradan cikmak icin kullaniyoruz
        driver.switchTo().parentFrame();// bir ust parente gonderiyor
        driver.switchTo().defaultContent();// en usteki parente gonderiyor. , more accurate
